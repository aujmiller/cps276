...
$elementsArr = [
    ...
    "address"=>[
      "errorMessage"=>"<span style='color: red; margin-left: 15px;'>Address cannot be blank and must be a set of numbers followed by letters</span>",
      "errorOutput"=>"",
      "type"=>"text",
      "value"=>"456 Example Road",
      "regex"=>"address"
    ],
    "city"=>[
        "errorMessage"=>"<span style='color: red; margin-left: 15px;'>City cannot be blank and must be only letters</span>",
        "errorOutput"=>"",
        "type"=>"text",
        "value"=>"Ann Arbor",
        "regex"=>"city"
    ...
    "state"=>[
        "type"=>"select",
        "options"=>["ca"=>"California","mi"=>"Michigan","oh"=>"Ohio","pa"=>"Pennsylvania","tx"=>"Texas"],
		    "selected"=>"mi"
	],
    "phone"=>[
    ...
    "email"=>[
        ...
        "errorOutput"=>"",
        "type"=>"text",
        "value"=>"amiller@email.com",
        "regex"=>"email"
    ],
    "dob"=>[
      "errorMessage"=>"<span style='color: red; margin-left: 15px;'>You must select a date of birth</span>",
      "errorOutput"=>"",
      "type"=>"text",
      "action"=>"required",
      "value"=>"2000-01-01",
...
function addData($post){
  ...
  /* IF EVERYTHING WORKS ADD THE DATA HERE TO THE DATABASE HERE USING THE $_POST SUPER GLOBAL ARRAY */
      ...
      if(isset($_POST['contacts'])){
        ...
        $contacts = "No Contact Information Added";
      }
...
$form = <<<HTML
    ...
    <div class="form-group">
      <label for="dob" class="form-label">Date of Birth {$elementsArr['dob']['errorOutput']}</label>

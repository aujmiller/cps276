...
class DatabaseConn {	
  ...
  public function dbOpen(){
    ...
    try {
      ...
      $dbHost = 'localhost';
      $dbName = 'aujmiller';//this will be your WCC username
      $dbUsr = 'aujmiller';//this will be your WCC username
      $dbPass = 'g5e2yAQkhwHJ';//this will be the password found in the video.
